...
Route::post('feedback/send', [HomeController::class, 'feedback'])->name('feedback.send');
Route::get('feedback/thankyou', [HomeController::class, 'thankyou'])->name('feedback.thankyou');
