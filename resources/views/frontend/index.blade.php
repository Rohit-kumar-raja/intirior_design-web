                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="project-carousel-v3 owl-carousel owl-theme">
                                ...
                                <div class="single-project-style3">
                                    <div class="img-holder">
                                        <img src="{{ url('frontend/images/projects/lat-pro-v3-2.jpg') }}"
                                            alt="Awesome Image">
                                        <div class="overlay-content">
                                            <div class="inner-content">
                                                <div class="links-icons">
                                ...
                                <div class="single-project-style3">
                                    <div class="img-holder">
                                        <img src="{{ url('frontend/images/projects/lat-pro-v3-3.jpg') }}"
                                            alt="Awesome Image">
                                        <div class="overlay-content">
                                            <div class="inner-content">
                                                <div class="links-icons">
                                ...
                                <div class="single-project-style3">
                                    <div class="img-holder">
                                        <img src="{{ url('frontend/images/projects/lat-pro-v3-4.jpg') }}"
                                            alt="Awesome Image">
                                        <div class="overlay-content">
                                            <div class="inner-content">
                                                <div class="links-icons">
