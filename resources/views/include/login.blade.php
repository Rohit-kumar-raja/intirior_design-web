...
<div id="loginModal3" class="modal-style-3 dark modal mt-5 pt-5">
    <div class="modal-dialog modal-login">
        <div class="modal-content pt-3">
            ...
            <div class="text-center mb-3">Don't have an account? <a class="register" href="#registerModal3"
    ...
    <div class="modal-dialog modal-login">
        <div class="modal-content pt-3">
            ...
            <div class="modal-body">
                ...
                <div class="text-center mb-3">Already have an account? <a class="login" href="#loginModal3"
