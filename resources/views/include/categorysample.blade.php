{{-- category2 section starts here --}}
         <!--Start Working Process Style2 Area-->
         <section class="working-process-style2-area" style="background-image:url({{url('frontend/images/parallax-background/working-process-bg-style3.jpg')}});">
            <div class="container">
                <div class="sec-title">
